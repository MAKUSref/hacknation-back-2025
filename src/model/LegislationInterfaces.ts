...
export enum LegislativeProcessStep {
  ZGLOSZENIA_LOBBINGOWE = "ZGLOSZENIA_LOBBINGOWE",
  UZGODNIENIA = "UZGODNIENIA",
  KONSULTACJE_PUBLICZNE = "KONSULTACJE_PUBLICZNE",
  OPINIOWANIE = "OPINIOWANIE",
  KOMITET_RM_DS_CYFRYZACJI = "KOMITET_RM_DS_CYFRYZACJI",
  KOMITET_DS_EUROPEJSKICH = "KOMITET_DS_EUROPEJSKICH",
  KOMITET_SPOLCZNY_RM = "KOMITET_SPOLCZNY_RM",
  KOMITET_EKONOMICZNY_RM = "KOMITET_EKONOMICZNY_RM",
  STALY_KOMITET_RM = "STALY_KOMITET_RM",
  KOMISJA_PRAWNICZA = "KOMISJA_PRAWNICZA",
  POTWIERDZENIE_PROJEKTU_PRZEZ_STALY_KOMITET_RM = "POTWIERDZENIE_PROJEKTU_PRZEZ_STALY_KOMITET_RM",
  RADA_MINISTROW = "RADA_MINISTROW",
  NOTYFIKACJA = "NOTYFIKACJA",
  PROJEKT_WPLYNAL_DO_SEJMU = "PROJEKT_WPLYNAL_DO_SEJMU",
  SKIEROWANO_DO_I_CZYTANIA_NA_POSIEDZENIU_SEJMU = "SKIEROWANO_DO_I_CZYTANIA_NA_POSIEDZENIU_SEJMU",
  SKIEROWANO_DO_I_CZYTANIA_W_KOMISJACH = "SKIEROWANO_DO_I_CZYTANIA_W_KOMISJACH",
  CZYTANIE_I_NA_POSIEDZENIU_SEJMU = "CZYTANIE_I_NA_POSIEDZENIU_SEJMU",
  CZYTANIE_II_NA_POSIEDZENIU_SEJMU = "CZYTANIE_II_NA_POSIEDZENIU_SEJMU",
  CZYTANIE_III_NA_POSIEDZENIU_SEJMU = "CZYTANIE_III_NA_POSIEDZENIU_SEJMU",
  I_CZYTANIE_W_KOMISJACH = "I_CZYTANIE_W_KOMISJACH",
  PRACA_W_KOMISJACH_PO_CZYTANIU = "PRACA_W_KOMISJACH_PO_CZYTANIU",
  SPRAWOZDANIE_PODKOMISJI = "SPRAWOZDANIE_PODKOMISJI",
  SPRAWOZDANIE_KOMISJI = "SPRAWOZDANIE_KOMISJI",
  GLOSOWANIE = "GLOSOWANIE",
  STANOWISKO_SENATU = "STANOWISKO_SENATU",
  PRACA_W_KOMISJACH_NAD_STANOWISKIEM_SENATU = "PRACA_W_KOMISJACH_NAD_STANOWISKIEM_SENATU",
  ROZPATRYWANIE_STANOWISKA_SENATU_NA_FORUM_SEJMU = "ROZPATRYWANIE_STANOWISKA_SENATU_NA_FORUM_SEJMU",
  USTAWE_PRZEKAZANO_PREZYDENTOWI_DO_PODPISU = "USTAWE_PRZEKAZANO_PREZYDENTOWI_DO_PODPISU",
  PREZYDENT_SKIEROWAL_DO_TK = "PREZYDENT_SKIEROWAL_DO_TK",
  WYROK_TK = "WYROK_TK",
  WNIOSEK_PREZYDENTA_VETO = "WNIOSEK_PREZYDENTA_VETO",
  WNIOSEK_PREZYDENTA_O_USUNIECIE_NIEZGODNOSCI = "WNIOSEK_PREZYDENTA_O_USUNIECIE_NIEZGODNOSCI",
  ROZPATRYWANIE_WNIOSKU_PREZYDENTA = "ROZPATRYWANIE_WNIOSKU_PREZYDENTA",
  ROZPATRYWANIE_SPRAWOZDANIA_KOMISJI_W_SPRAWIE_USUNIECIA_NIEZGODNOSCI = "ROZPATRYWANIE_SPRAWOZDANIA_KOMISJI_W_SPRAWIE_USUNIECIA_NIEZGODNOSCI",
  PODPISANIE_USTAWY_PRZEZ_PREZYDENTA = "PODPISANIE_USTAWY_PRZEZ_PREZYDENTA",
  OGLOSZENIE_USTAWY = "OGLOSZENIE_USTAWY",
}
